...
```{r}
filename <- "/Users/Audiorunner13/CUNY MSDS Course Work/DATA607 Spring 2021/Week3/Data/veggies.txt"
berry_veg <- read.delim(filename, header = FALSE, quote = "")
berry_veg$V1
```
