...
We can summarize the ROC curve by calculating the area under the curve (AUC).  In this case, the ROC AUC is 0.55 which translates to an A in the letter grade scale below.
