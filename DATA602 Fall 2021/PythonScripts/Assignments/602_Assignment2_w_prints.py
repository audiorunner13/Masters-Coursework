...
def exercise02():
    # Repeat exercise 1 and loop through and print each item in the animal list by iterating 
    # through an index number and using 
    # range(). Set the variable len_animals to the length of the animal list.
...
def exercise03():
    # Programmatically reorganize the countdown list below in descending order and return the 
    # value of the 5th element in the sorted countdown list.
    # The 5th element will be stored in the variable the_fifth_element, which currently below 
    # has a dummy value of -999.
...
def exercise04(more_temperatures, iot_sensor_points, a, b, c, d, e):
    ...
    # where the key is an arbitrary sequential number 
    # and the value is the temperature and a,b,c,d and e are each a single temperature reading
    # To Do:
    ...
    # print("1. Add all of the items in more_temperatures to the temperatures list")
    temperatures.extend(more_temperatures)
    
    # print(temperatures)
    
    # print("2. Add all of the temperature values in iot_sensor_points to the temperatures list")
    for (k,v) in iot_sensor_points.items():
        temperatures.append(v)

    # print(temperatures)
    
    # print("3. Add a,b,c,d and e to the temperature list")
    ...
    # print("4. Organize the temperatures in descending order")
    temperatures.sort()
    temperatures.reverse()
    
    # print(temperatures)

    # print("5. The samples list will contain every 5th reading from the final temperatures list.")
    cnt = 4
    i = 0
    ...
    # print("6. Do a shallow copy of samples into copy_of_samples" )
    copy_of_samples = copy.copy(samples)

    # print(copy_of_samples)
            
    # print("7. Organize samples in ascending order")
    samples.sort()
...
def exercise05(n):
    ...
    # when n == 1 then exit function and return the result n
    if n == 1:
        return n
...
def exercise06(n):
     # This function will receive an arbitrary list of numbers of arbitrary size and find the 
     # average of those numbers. The size of the list may vary. Find the method that requires 
     # the least amount of code. Return back the length, sum of list and average of list

    # ------ Place code below here \/ \/ \/ ------
        
    length_n = len(n)
    # print("length", length_n)
...
def exercise07(n):
    # This function looks for duplicates in list n. If there is a duplicate True is returned. If 
    # there are no duplicates False is returned.
    ...
    while curr < len(n):
        ...
        if n[curr] == n[next]:
            # print("Dupes", n[curr], n[next])
            return True
        # else:
        #     print("Not Dupe", n[curr], n[next])
...
def exercise09():
    # Compile a list of 11 random URLs of dog pics. You will simply APPEND the dogs list with URLs
    # of pics so that the list contains 11 URLs. This means you will extract the URL and insert 
    # into the list dogs.
    # In the end, you will have a list called dogs that will have 11 items in it. Each item is a 
    # string, each string contains a random URL to a dog pic. The source of one dog pic URL is 
    # one r.get call. You will make 11 calls to receive 11 random dog pic URLs.
...
def exercise10(sentence):
    ...
    # Exercise10 receives an arbitrary string. Return the sentence backwards with the cases 
    # inverted and spaces an underscore _, i.e. HelLo returns OlLEh
    reversed = ''
    ...
    for s in sentence:
        if s.isupper():
            reversed = s.lower() + reversed
        else:
            reversed = s.upper() + reversed
