...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep  7 09:01:37 2021
...
def exercise03():
    ...
    sentence = "Derek Jeter is the best shortstop ever."
    print(sentence)
...
def exercise04():
    # Create two string variables. The first variable is called first_name, the second is last_name. Set both variables to your first name 
...
def exercise05():
    ...
    print(first_name, last_name, name_type)
...
def exercise06():
    ...
    print(hours_worked, wage_per_hour, total_pay)
...
def exercise07():
    # Create a variable wage and assign 17.0 to it. Print to the screen the datatype of wage. Create a second variable 
    # called doubled that prints to the screen 2 times wage
...
def exercise08():
    # Assign 5 to the variable quantity, 'hello' to the variable hello and a variable hello_repeated that holds a string that 
    # contains whatever is contained in the variable hello repeated quantity times
    ...
    print(quantity, hello, hello_repeated)
...
def exercise10():
    # Create 5 variables named factorN where N is the numbers 1 to 5 and set them to 1 through 5, respectively. Create a
    # variable called product that holds the product of the 5 variables
...
def exercise14():
    # Create a variables area, length, height. Set length and height equal to 50 and 10.2 respectively. Assign area to the 
    # product of length and height, assign the variable area_type to the datatype of area
    ...
    area = length * height
    area_type = type(area)
    print(area, length, height, area_type)
...
def exercise15():
    ...
    print(distance, speed_mph, duration)
...
def exercise16():
    # Implement pythogorean thereom and find the length of hypotenuse c given sides a and b. Select any numbers for a and b. 
